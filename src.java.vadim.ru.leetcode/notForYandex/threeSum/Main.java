 ...
 * т.е. проверка каждой комбинации. А именно, если результат при тройном лсожении получается больше 0, сдвигаем правый офсет влево
