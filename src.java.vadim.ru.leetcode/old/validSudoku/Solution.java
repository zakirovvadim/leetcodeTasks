...
/**
 *Вычисляем уникальность по строке, по столбцу и внутри квадрата 3х3,
 * координаты квадрата вычисляем как деление без остатка X / 3 и Y / 3,
 * таким образом будет вычеслена нужная тройка координат квадрата.
 * Для строки, столбца и квадарата 3х3 создаем хешСеты, где можно проверить униклаьность добалвяя если нету туда числа при
 * итерациях.
 */
