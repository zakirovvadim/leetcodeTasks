package old.containsNearbyDuplicate;
 ...
 * Тем самым проверяем если длина между i минус левый больше размера k, значит нам надо удалить из хешСета левый элемент
